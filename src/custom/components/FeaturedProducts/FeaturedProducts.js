          ...
          <div className="featured-2">
            <div className="bg1">
              ...
              {/*<a className="video-thumbnail" href="#">*/}
                ...
                <iframe className="video-thumbnail" width="300" height="180" src="https://www.youtube.com/embed/jUlrJVuBj40" frameBorder="0"
              ...
              <div className="content-container">
                ...
                {/*</button>*/}
                <a className="watch-btn" href="https://www.youtube.com/watch?v=jUlrJVuBj40" target="_blank">
                  <i className="zmdi zmdi-triangle-down" /> Watch Now
                </a>
              </div>
            </div>
